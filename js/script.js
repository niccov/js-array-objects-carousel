...
let titolElement = document.getElementById("container-title");
let textElement = document.getElementById("container-text");
...
downArrowElement.addEventListener("click", function() {
   if(contatore == images.length - 1) {
    ...
    activeImgElement.src = images[contatore].image;
    
    titolElement.innerHTML = images[contatore].title;

    textElement.innerHTML = images[contatore].text;
